...
Once you have created and configured your Honeycomb project, the next step is to add Honeycomb services. Honeycomb services are essential components that provide specialized functionalities within the Honeycomb Protocol ecosystem. Currently, the two main suites of services are:
...
Add to your project by following this [documentation](/programs/currency-manager)
...
Add to your project by following this [documentation](/programs/nectar-staking)
...
Add to your project by following this [documentation](/programs/nectar-missions)
